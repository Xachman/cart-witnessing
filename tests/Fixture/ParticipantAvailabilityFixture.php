...
/**
 * ParticipantAvailabilityFixture
 *
 */
class ParticipantAvailabilityFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'participant_availability';
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'participant_availability_ibfk_1' => ['type' => 'foreign', 'columns' => ['location_id'], 'references' => ['locations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'participant_availability_ibfk_2' => ['type' => 'foreign', 'columns' => ['participant_id'], 'references' => ['participants', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-19 17:40:39',
            'modified' => '2016-11-19 17:40:39'
        ],
    ];
}
