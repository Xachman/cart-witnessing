...
class LocationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'day' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'start_time' => '21:28:15',
            'end_time' => '21:28:15',
            'created' => '2016-11-15 21:28:15',
            'modified' => '2016-11-15 21:28:15'
        ],
    ];
}
