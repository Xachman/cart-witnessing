<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Send Email'), ['controller' => 'Emails', 'action' => 'sendMail', $email->id], ['confirm' => 'Send email?']) ?> </li>
        <li><?= $this->html->link(__('Send Test Email'), ['controller' => 'Emails', 'action' => 'sendTestEmail', $email->id]) ?> </li>
    </ul>
</nav>
